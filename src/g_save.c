...
//bcass start - easter_egg cvar, AGAIN
	...
	run_pitch	= gi.cvar ("run_pitch", "0.001", 0);
	run_roll	= gi.cvar ("run_roll",	"0.001", 0);
	bob_up		= gi.cvar ("bob_up",	"0.001", 0);
	bob_pitch	= gi.cvar ("bob_pitch", "0.001", 0);
	bob_roll	= gi.cvar ("bob_roll",	"0.001", 0);
...
//	axisbots = gi.cvar ("axisbots", "0", CVAR_LATCH);
	...
	*/
	...
	// evil: re-initialize timelimit to zero
	timelimit->value = 0;
